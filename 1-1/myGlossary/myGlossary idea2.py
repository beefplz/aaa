...
Button(window, text="답 얻기", width=10, command=click).grid(row=2, column=0, sticky=W)

Button(window, text="질문 얻기", width=10, command=click1).grid(row=0, column=0, sticky=W)

Button(window, text="다음 질문", width=10, command=click1).grid(row=0, column=0, sticky=E)
